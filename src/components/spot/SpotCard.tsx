...
const IMAGE_WRAPPER_CLASSES =
  'relative h-48 w-full overflow-hidden bg-black/5';
...
function toggleAriaLabel(spot: Spot, isSaved: boolean, remove: boolean): string {
  if (remove || isSaved) {
      ...
      <div className={IMAGE_WRAPPER_CLASSES}>
        ...
        >
          ...
          <Image
            ...
            className="object-cover grayscale transition-transform duration-500 ease-out group-hover:scale-105 pointer-events-none"
