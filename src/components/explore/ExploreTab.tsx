...
export default function ExploreTab() {
  ...
  const categories = useMemo(() => getExploreCategories(), []);
  const legendary = useMemo(() => getLegendaryTerrains(), []);
            ...
            >
              <div className="h-32 bg-black overflow-hidden relative">
                <Image
                  ...
                  fill
                  sizes="280px"
                  className="object-cover grayscale opacity-90 transition-transform duration-500 hover:scale-105"
                  referrerPolicy="no-referrer"
                  unoptimized
                />
                <div
