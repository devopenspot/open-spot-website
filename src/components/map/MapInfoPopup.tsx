...
function MapInfoPopupBase() {
  ...
  return (
    <div
      ...
      tabIndex={-1}
      className="fixed bottom-2 md:absolute left-2 right-2 z-[1000] md:left-auto md:right-4 w-auto md:w-96 bg-surface/95 backdrop-blur-md border border-outline-variant shadow-lg p-4 animate-slide-up outline-none space-y-3"
    >
