export interface PresetImageSeed {
  slug: string
  name: string
  url: string
  sortOrder: number
...
export const PRESET_IMAGE_SEED: readonly PresetImageSeed[] = [
  {
    slug: "industrial-ledge",
